...
Build.prototype.makeFullResult = function(container,result,style,name){
    ...
    var row2 = this.makeElement(result_container,"Div","block");
        ...
        this.appendList(row2,result['classification'],"list-item-" + style,"classification","click","run_search");
        ...
        for(var cuisine_subhead in result.cuisine){
            ...
            var cusine_label = this.makeElement(row2,"Div","result-label-" + style + " inline-flex","cuisine_"+cuisine,cuisine+":");
...
Build.prototype.makeSearchBar = function(container,style){
    ...
    var searchBar = this.makeElement(content,"Div","search-bar " + style,"");
    var searchBarInput = this.makeElement(searchBar,"Input","search-bar-input","search-input");
    this.bindEventListener("search-input","update_text","input");
    
    var searchButton = this.makeElement(searchBar,"Button","search-button","search","<span class='glyphicons glyphicons-question-sign seach-button icon'></span>");
